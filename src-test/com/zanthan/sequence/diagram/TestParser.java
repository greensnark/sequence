...
public class TestParser
    ...
    private static final Logger log =
            Logger.getLogger(TestParser.class);
    ...
    public void test00() {
        ...
        diagram.parse(new PushbackReader(new StringReader("(objOne methOne (objTwo methTwo))")));
