...
public class ModelParseFailedEvent
        extends ModelEvent {

    private ParserException parserException;

    public ModelParseFailedEvent(Object source, String text, Diagram diagram, ParserException pe) {
        super(source, text, diagram);
        this.parserException = pe;
    }
